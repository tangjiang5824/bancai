Ext.define('data.Upload_Data', {
	...
	initComponent : function() {
		...
		var store= Ext.create('Ext.data.Store', {
            fields: ['id', '品号', '品名','规格','库存单位','仓库编号','数量','成本','存放位置'],
            data: { 'items': [
        { 'id': '1', "品号": "aa", "品名": "旧" ,"规格":"大","库存单位":"dd","仓库编号":"1","数量":"121","成本":"1900","存放位置":"仓库1"},
        { 'id': '2', "品号": "aa", "品名": "旧" ,"规格":"大","库存单位":"dd","仓库编号":"1","数量":"121","成本":"1900","存放位置":"仓库1"},
