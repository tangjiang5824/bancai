Ext.define('tax.edit.reportForms',{
			...
			items: [ 
				      {
				        ...
				        name: 'startTime',
				        format: 'Y-m',
						value:Ext.util.Format.date(Ext.Date.add(new Date(),Ext.Date.MONTH,-6),"Y-m"),
//				        listeners: {
...
//				         }
				...
				,{
						...
						margin : '0 10 0 0',
						handler : function() {
							var adminMain=Ext.getCmp("adminMain");
							if(adminMain!=null)
							{
...
//			 autoLoad: true,
			 ...
			 fields: ['name','tableName','onTimeNum','advancedCount','delayNum','noUploadNum','uploadCount','recordCount'],				
				proxy:{	
					url: 'tax/edit/listReport.do',
					type: 'ajax',
					reader:{
						type : 'json'
						//rootProperty: 'value',
...
//	                return Ext.String.format('合计：', value, value !== 1 ? '' : '');
//	                }
