Ext.define('material.material_Warning',{
    ...
    initComponent: function(){
        ...
        var material_Warning_Store = Ext.create('Ext.data.Store',{
            id: 'material_Warning_Store',
            autoLoad: true,
            fields: [],
        ...
        var grid = Ext.create('Ext.grid.Panel',{
            id: 'material_Warning_Main',
            store: material_Warning_Store,
            viewConfig : {
            ...
            dockedItems: [{
                xtype: 'pagingtoolbar',
                store: material_Warning_Store,   // same store GridPanel is using
                dock: 'bottom',
                displayInfo: true,
