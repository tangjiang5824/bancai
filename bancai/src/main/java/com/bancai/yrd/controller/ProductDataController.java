...
//    }
    ...
    public WebResponse preprocessAddDataRollback(String preprocesslogId,String operator,HttpSession session) throws ParseException {
        WebResponse response = new WebResponse();
    ...
    public WebResponse backproductAddDataRollback(String backproductlogId,String operator,HttpSession session) throws ParseException {
        WebResponse response = new WebResponse();
        if(operator==null||operator.trim().length()==0){
            response.setErrorCode(300);
            response.setMsg("请选择撤销人！");
    ...
    public WebResponse uploadPreprocess(MultipartFile uploadFile) throws IOException {
        WebResponse response = new WebResponse();
    ...
    public WebResponse uploadBackproduct(MultipartFile uploadFile) throws IOException {
        WebResponse response = new WebResponse();
    ...
    public WebResponse wasteUploadExcel(MultipartFile uploadFile) throws IOException {
        WebResponse response = new WebResponse();
    ...
    public WebResponse wasteAddDataRollback(String wastelogId,String operator,HttpSession session) throws ParseException {
        WebResponse response = new WebResponse();
       if(operator==null||operator.trim().length()==0){
           response.setErrorCode(300);
           response.setMsg("请选择撤销人！");
