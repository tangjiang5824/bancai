Ext.define('preprocess.preprocess_Receive',{
    ...
    initComponent: function(){
        ...
        //查询领料单
        var PreprocesspickListStore = Ext.create('Ext.data.Store',{
        ...
        //             //获取数据
        //             Ext.Ajax.request({
        //                 url : 'preprocess/updateprojectpreprocesslist.do', //预加工半成品入库
        //                 method:'POST',
        ...
        var grid1=Ext.create('Ext.grid.Panel',{
            ...
            dockedItems: [
                {
                    xtype: 'pagingtoolbar',
                    store: PreprocesspickListStore,   // same store GridPanel is using
                    dock: 'bottom',
                    displayInfo: true,
            ...
            listeners: {
                ...
                itemdblclick: function(me, record, item, index,rowModel){
                    ...
                    // var specificPreprocessList = Ext.create('Ext.data.Store',{
                    ...
                    //     proxy : {
                    //         type : 'ajax',
                    //         url : 'order/queryRequisitionOrderDetail.do?requisitionOrderId='+requisitionOrderId,//获取同类型的预加工半成品  +'&pickNum='+pickNum
                    //         reader : {
                    //             type : 'json',
                    ...
                    toolbar_show_pre.items.items[0].setValue(requisitionOrderId);
                    toolbar_show_pre.items.items[1].setValue(requisitionOrderNo);
                    toolbar_show_pre.items.items[2].setValue(projectId);
                    toolbar_show_pre.items.items[3].setValue(projectName);
        ...
        var toolbar_show_pre = Ext.create('Ext.toolbar.Toolbar',{
            // dock : "top",
            id : "toolbar_show_pre",
            items: [
                {
        ...
        var grid__query_pickList_specific=Ext.create('Ext.grid.Panel',{
            ...
            dockedItems: [
                {
                    xtype: 'pagingtoolbar',
                    store: specificPreprocessList,   // same store GridPanel is using
                    dock: 'bottom',
                    displayInfo: true,
                    displayMsg:'显示{0}-{1}条，共{2}条',
                    emptyMsg:'无数据'
        ...
        //领料的具体材料信息Panel
        var panel_specific_pre = Ext.create('Ext.panel.Panel',{
            // title: '领料单材料详情',
            //dock: 'bottom',
            layout:{
                type:'vbox',
