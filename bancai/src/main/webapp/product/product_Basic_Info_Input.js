Ext.define('product.product_Basic_Info_Input', {
                            ...
                            Ext.Msg.show({
                                ...
                                fn : function(btn) {
                                    if (btn === 'yes') {
                                        ...
                                        form.submit({
                                            url : 'product/uploadExcelBasicInfo.do', //上传excel文件，并回显数据，退库成品批量上传
                                            waitMsg : '正在上传...',
                            ...
                            success : function(response) {
                                ...
                                if(success == false){
                                    ...
                                    if(errorCode == 200){
                                        ...
                                        Ext.MessageBox.alert("提示","录入失败，未知错误！请重新入库" );
                                    }
                                }else{
                                    post_flag =false;
