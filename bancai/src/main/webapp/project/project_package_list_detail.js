Ext.define('project.project_package_list_detail',{
    ...
    initComponent: function(){
        ...
        //弹出表格，楼栋信息表
        var packageProductInfoGrid=Ext.create('Ext.grid.Panel',{
            id : 'packageProductInfoGrid',
            ...
            columns:[
                ...
                //         //         // Ext.getCmp('packageProductInfoGrid').getStore().remove(rec);
                //         //     }
                //         // },
                //         //删除按钮
                //         {
            ...
            dockedItems: [{
                xtype: 'pagingtoolbar',
                //store: packageProductInfoStore,   // same store GridPanel is using
                dock: 'bottom',
                displayInfo: true,
            ...
            //                 }
            //                 //重新加载
            //                 Ext.getCmp('packageProductInfoGrid').getStore().load();
            //             },
            //             failure:function (response) {
            ...
            items: [
                ...
                },
                {
                    ...
                    handler : function() {
                        ...
                        Ext.getCmp('packageProductInfoGrid').getStore().loadData(data,
                            true);
        ...
        var grid = Ext.create('Ext.grid.Panel',{
            ...
            listeners: {
                ...
                itemdblclick: function(me, record, item, index,rowModel){
                    ...
                    var packageProductInfoStore = Ext.create('Ext.data.Store',{
                        //id,materialName,length,width,materialType,number
                        fields:['productName','position','figureNum','packageId'],
                        proxy : {
                            type : 'ajax',
                            url : 'project/queryPackageProduct.do?tableName=designlist_view&packageId='+packageId,//获取同类型的原材料  +'&pickNum='+pickNum
                            reader : {
                                type : 'json',
                                rootProperty: 'value',
                            },
                    ...
                    packageProductInfoGrid.setStore(packageProductInfoStore);
        ...
        function cellclick(grid, rowIndex, columnIndex, e) {
            ...
            var packageId = e.data.id;
            var projectId = e.data.projectId;
            var buildingId = e.data.buildingId;
            var buildingpositionId = e.data.buildingpositionId;
            console.log("wai packageId="+packageId)
            if (columnIndex == 6) {
                //console.log("zzzzzzzzzzzzzzzzzyyyyyyyyyyyyyyyyyyyzzzzz打印")
                console.log("nei packageId="+packageId)
                var packageProductInfoStore = Ext.create('Ext.data.Store',{
                    //id,materialName,length,width,materialType,number
                    fields:['productName','position','figureNum','packageId'],
                    proxy : {
                        type : 'ajax',
                        url : 'project/queryPackageProduct.do?tableName=designlist_view&packageId='+packageId+'&projectId='+projectId+'&buildingId='+buildingId+'&buildingpositionId='+buildingpositionId,//获取同类型的原材料  +'&pickNum='+pickNum
                        reader : {
                            type : 'json',
                            rootProperty: 'value',
                        },
