Ext.define('project.management.queryproject',{
    ...
    initComponent: function(){
        ...
        Ext.define('Project.status.State', {
            statics: { // 关键
                0: { value: '0', name: '初始状态' },
                1: { value: '1', name: '进行中' },
                9: { value: '1', name: '已结项' },
        ...
        var grid = Ext.create('Ext.grid.Panel',{
            ...
            columns : [
                ...
                { text: '项目状态', dataIndex: 'statusId', flex :1,
                    renderer: function (value) {
                        return Project.status.State[value].name; // key-value
                    },
                },
                {
                    // name : '操作',
...
//添加cell单击事件
        ...
        function cellclick(grid, rowIndex, columnIndex, e) {
            ...
            //console.log("grid.columns[columnIndex]：",Ext.getCmp('grid').columns[columnIndex-1])
            //var fieldName = Ext.getCmp('grid').columns[columnIndex].text;
