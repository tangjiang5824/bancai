Ext.define('project.management.project_process_status',{
    ...
    initComponent: function(){
        ...
        //进度结果
        var process_status_Store = Ext.create('Ext.data.Store',{
            id: 'process_status_Store',
            // autoLoad: true,
            fields: [],
            pageSize: itemsPerPage, // items per page
            proxy:{
                url : "material/findAllBytableName.do?tableName="+tableName_process,//通用接口
                type: 'ajax',
                reader:{
                    type : 'json',
                    rootProperty: tableName_process,
        ...
        var grid = Ext.create('Ext.grid.Panel',{
            ...
            columns : [
                ...
                { text: '下料完成', dataIndex: '下料完成', flex :1 },
                { text: '焊接完成', dataIndex: '焊接完成', flex :1 },
                { text: '组装完成', dataIndex: '组装完成', flex :1 },
                // {
                //     text : '匹配详细信息',
                //     flex :1 ,
            ...
            dockedItems: [{
                xtype: 'pagingtoolbar',
                store: process_status_Store,   // same store GridPanel is using
                dock: 'bottom',
                displayInfo: true,
