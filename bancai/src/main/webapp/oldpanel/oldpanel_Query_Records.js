Ext.define('oldpanel.oldpanel_Query_Records',{
    ...
    initComponent: function(){
        ...
        var optionType = Ext.create('Ext.form.ComboBox', {
            fieldLabel: '操作类型',
            name: 'pro_query_records_optionType',
            id: 'pro_query_records_optionType',
        ...
        var toobar = Ext.create('Ext.toolbar.Toolbar',{
            ...
            items: [
                ...
                },
                {
                    ...
                    layout: 'right',
                    handler: function(){
                        old_Query_Records_store.load({
                            params : {
                                operator : Ext.getCmp('operator').getValue(),
                                endTime : Ext.getCmp('endTime').getValue(),
                                startTime:Ext.getCmp('startTime').getValue(),
                                projectId:Ext.getCmp('projectName').getValue(),
                                type:Ext.getCmp('pro_query_records_optionType').getValue(),
                                tableName:tableName_old_records,
                            }
                        });
                    }
                },
        ...
        var old_Query_Records_store = Ext.create('Ext.data.Store',{
            id: 'old_Query_Records_store',
            autoLoad: true,
            fields: [],
        ...
        var old_Query_Records_store1=Ext.create('Ext.data.Store',{
            id: 'old_Query_Records_store1',
            fields:['原材料名称','数量'],
            data:sampleData
        });
        ...
        //弹出框
        var old_Query_Records_specific_data_grid=Ext.create('Ext.grid.Panel',{
            id : 'old_Query_Records_specific_data_grid',
            store:old_Query_Records_store1,//oldpanellogdetailList，store1的数据固定
            dock: 'bottom',
            columns:[
                {
                    text: '旧板名称',
        ...
        var old_Query_Records_win_showmaterialData = Ext.create('Ext.window.Window', {
            // id:'old_Query_Records_win_showmaterialData',
            title: '旧板出入库详细信息',
            height: 500,
            width: 650,
            layout: 'fit',
            ...
            draggable:true,
            closeAction : 'hidden',
            items:old_Query_Records_specific_data_grid,
        });
        ...
        var grid = Ext.create('Ext.grid.Panel',{
            ...
            dockedItems:[{
                xtype: 'pagingtoolbar',
                store: old_Query_Records_store,   // same store GridPanel is using
                dock: 'bottom',
                displayInfo: true,
            ...
            listeners: {
                ...
                itemdblclick: function(me, record, item, index){
                    ...
                    console.log(id);
                    console.log(opType)
                    var prologdetailList = Ext.create('Ext.data.Store',{
                        ...
                        proxy : {
                            ...
                            url : 'material/findAllbyTableNameAndOnlyOneCondition.do?tableName=oldpanel_logdetail_oldpanelName&columnName=oldpanellogId&columnValue='+id,//获取同类型的原材料
                            reader : {
                                type : 'json',
                    ...
                    // 根据出入库0/1，决定弹出框表格列名
                    var col = old_Query_Records_specific_data_grid.columns[1];
                    if(opType == 1){
                        col.setText("出库数量");
                    }
                    if(opType == 2){
                    ...
                    old_Query_Records_specific_data_grid.setStore(prologdetailList);
                    console.log(prologdetailList);
                    old_Query_Records_win_showmaterialData.show();
                }
            }
        });
